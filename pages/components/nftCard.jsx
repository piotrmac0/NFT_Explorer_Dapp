        ...
        <div className="w-3/4 md:w-1/4 flex flex-col rounded-lg">
            ...
            <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-lg h-110">
                <div>
                    ...
                    <h2 className="text-gray-800 font-bold">{nft.title.match(/#(\d+)/)}</h2>
                    ...
                    <div className="flex justify-center mb-1">
                        <a href={`https://opensea.io/assets/ethereum/${nft.contract.address}/${value}`} target={"_blank"} className="py-2 px-4 bg-blue-500 w-3/5 md:w-5/5 text-center rounded-lg text-white cursor-pointer mt-3">See on Opensea</a>
                    </div>
                </div>
            </div>
